...
/* ****** PROJECT : Amazing Numbers - Stage 3 ******
 * 
 * Description
 ...
 * it from right, it becomes 4321. Add this new property to our program.
 * 
 * In previous stages, the program could process only one number. From now on, 
 * the program should accept a request from a user, analyze and execute it. 
 * The program should print Enter a request instead of asking for a natural 
 * number. The program should also continue execution unless a user enters a 
 * terminate command. Let's make it 0 (zero).
 * 
 * Your program should welcome users and print the instructions. At this 
 * point, make your program execute two commands. If a user enters a natural 
 * number, the program should indicate the properties of that number. If a 
 * user enters zero, then the program should exit. If a user enters a 
 * negative number by mistake, print an error message.
 * 
 * Objectives
