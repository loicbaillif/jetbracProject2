...
public class TheoRobotUs implements TheoryInterface {
	...
	public int timesFive(int userInput) {
		...
		System.out.println("I can do it in 5 steps!");
		System.out.printf("\t1) %d + %d = %d", userInput, userInput, result);
		System.out.printf("\t2) %d + %d = %d", result, userInput, 
				result + userInput);
		result += userInput;
		System.out.printf("\t3) %d + %d = %d", result, userInput, 
				result + userInput);
		result += userInput;
		System.out.printf("\t4) %d + %d = %d", result, userInput, 
				result + userInput);
		result += userInput;
